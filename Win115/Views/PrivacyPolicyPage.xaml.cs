...
namespace Win115.Views
{
    ...
    public sealed partial class PrivacyPolicyPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            txt_privacy_policy.Text = @"# 隐私政策

本软件指“115 Plus”软件（以下称本软件）。
...
- 在使用本软件网络服务进行网上交易时，您不可避免的要向交易对方或潜在的交易对方披露自己的个人信息，如联络方式或者邮政地址。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。如您发现自己的个人信息泄密，尤其是本软件用户名及密码发生泄露，请您立即联络本软件客服，以便本软件采取相应措施。".StringTrim();
        }
    }
}
