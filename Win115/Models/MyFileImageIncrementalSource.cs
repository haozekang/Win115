...
{
    public class MyFileImageIncrementalSource : IIncrementalSource<MyFileItemModel>
    {
        ...
        public MyFileImageIncrementalSource(long pathId, string sortDirection, string sortField)
        {
            _pathId = pathId;
