...
{
    public class MyFileMediaIncrementalSource : IIncrementalSource<MyFileItemModel>
    {
        ...
        public MyFileMediaIncrementalSource(long pathId, string sortDirection, string sortField)
        {
            _pathId = pathId;
        ...
        public async Task<IEnumerable<MyFileItemModel>> GetPagedItemsAsync(int pageIndex, int pageSize, CancellationToken cancellationToken = default)
        {
            ...
            req.AddQueryParameter("stdir", 0);
            req.AddQueryParameter("show_dir", 0);
